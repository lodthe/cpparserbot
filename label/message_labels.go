...
*/getbinance* - получить документ с информацией о всех Binance курсах.

*/getall* - получить документ с релевантной информацией о всех поддерживаемых курсах.
`
...
`
	GetAllPrices = `Документ с последней информацией о курсах.
`
